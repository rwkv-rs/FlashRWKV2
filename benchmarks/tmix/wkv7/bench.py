...
SOURCE_FAMILY = ImportedSourceFamily(
    ...
    paths=(
        ...
        "csrc/sm80/tmix/wkv7/infer_recurrent_fp32io16_forward_varlen.cu",
        "csrc/sm80/tmix/wkv7/infer_recurrent_fp32io16_forward_varlen.cpp",
        "csrc/sm80/tmix/wkv7/infer_recurrent_fp16_forward_varlen.cu",
        "csrc/sm80/tmix/wkv7/infer_recurrent_fp16_forward_varlen.cpp",
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp16_forward_varlen.cu",
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp16_forward_varlen.cpp",
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp32io16_forward_varlen.cu",
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp32io16_forward_varlen.cpp",
    ),
)
...
def _native_source_set_hash(root: Path) -> str:
    relative_paths = (
        ...
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp32io16_forward_varlen.cu",
        "csrc/sm80/tmix/wkv7/infer_recurrent_deltalog_fp32io16_forward_varlen.cpp",
        "csrc/sm80/tmix/wkv7/recurrent_decay.cuh",
    )
