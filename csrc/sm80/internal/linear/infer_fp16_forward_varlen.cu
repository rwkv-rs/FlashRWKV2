...
// Native-private Linear provider. This translation unit has no pybind
...
at::Tensor internal_linear_rank_projection_f16_cuda(
  ...
  if (FLASHRWKV_TARGET_SM == 120 && channels64 == 4096) {
